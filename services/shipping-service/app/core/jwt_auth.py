...
# Cache public key (PEM) — refresh mỗi 1 giờ.
...
async def _get_public_key() -> str:
    """Lấy RSA public key của realm từ Keycloak, cache 1 giờ."""
    now = time.time()
...
async def verify_token(token: str) -> Dict[str, Any]:
    """Verify chữ ký RS256 + exp + issuer; trả claims hoặc raise UnauthorizedException."""
