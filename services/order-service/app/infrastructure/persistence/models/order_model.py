...
class OrderModel(Base):
    ...
    addresses = relationship("OrderAddressModel", back_populates="order", cascade="all, delete-orphan")
    status_history = relationship(
        "OrderStatusHistoryModel", back_populates="order", cascade="all, delete-orphan"
    )
    saga_state = relationship("SagaStateModel", back_populates="order", cascade="all, delete-orphan")
