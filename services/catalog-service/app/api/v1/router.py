...
from app.api.v1.merchant import profile as merchant_profile
from app.api.v1.public import product as public_product
from app.api.v1.public import media as public_media
...
api_router.include_router(public_media.router,     prefix="/public",           tags=["Public Media"])
api_router.include_router(merchant_product.router, prefix="/merchant/products", tags=["Merchant Products"])
api_router.include_router(merchant_profile.router, prefix="/merchant",          tags=["Merchant Profile/Registration"])
