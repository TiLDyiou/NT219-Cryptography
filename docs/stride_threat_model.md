...
1. [Giới thiệu STRIDE](#1-giới-thiệu-stride)
2. [Xác định phạm vi hệ thống](#2-xác-định-phạm-vi-hệ-thống)
3. [Phân tích STRIDE theo từng thành phần](#4-phân-tích-stride-theo-từng-thành-phần)
